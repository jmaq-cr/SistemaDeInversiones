using SistemaInversionesConsola.PaqueteControl;
using System;
...
namespace SistemaInversionesConsola
{
    class Program
    {
        ...
        static void principal()
        {
            ...
            if (eleccion())
            {
                ...
                Entrada consulta1 = control.calcularInversion(nombre, tipo, monto, plazo, moneda);
